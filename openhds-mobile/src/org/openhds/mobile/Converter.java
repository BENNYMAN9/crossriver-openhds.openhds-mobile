...
public class Converter {
    ...
    private static void populateIndividual(Cursor cursor, Individual individual) {
        ...
        individual.setStatus(cursor.getString(cursor.getColumnIndex(OpenHDS.Individuals.COLUMN_INDIVIDUAL_STATUS)));
        individual.setUuid(cursor.getString(cursor.getColumnIndex(OpenHDS.Individuals.COLUMN_INDIVIDUAL_UUID)));
    }
    ...
    private static void populateLocation(Cursor cursor, Location location) {
        ...
        location.setHead(cursor.getString(cursor.getColumnIndex(OpenHDS.Locations.COLUMN_LOCATION_HEAD)));
        ...
        location.setStatus(cursor.getString(cursor.getColumnIndex(OpenHDS.Locations.COLUMN_LOCATION_STATUS)));
    ...
    private static void populateHierarchy(Cursor cursor, LocationHierarchy hierarchy) {
        ...
        hierarchy.setUuid(cursor.getString(cursor.getColumnIndex(OpenHDS.HierarchyItems.COLUMN_HIERARCHY_UUID)));
    }
    ...
    private static void populateSocialGroup(Cursor cursor, SocialGroup sg) {
        ...
        sg.setStatus(cursor.getString(cursor.getColumnIndex(OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_STATUS)));
        sg.setUuid(cursor.getString(cursor.getColumnIndex(OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_UUID)));
    }
    ...
    public static List<Round> toRoundList(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            round.setUuid(cursor.getString(cursor.getColumnIndex(OpenHDS.Rounds.COLUMN_ROUND_UUID)));
            rounds.add(round);
        }
