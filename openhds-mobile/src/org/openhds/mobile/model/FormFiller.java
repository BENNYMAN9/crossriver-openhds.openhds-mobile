...
public class FormFiller {
    ...
    public FilledForm fillLocationForm(LocationVisit locationVisit) {
        ...
        addHouse(locationVisit, form);

        form.setHierarchyId(locationVisit.getVillage().getExtId());
        form.setIndividualExtId(locationVisit.getLocation().getHead());

        return form;
    }

    private void addHouse(LocationVisit locationVisit, FilledForm form) {
        form.setHouseId(locationVisit.getLocation().getExtId());
