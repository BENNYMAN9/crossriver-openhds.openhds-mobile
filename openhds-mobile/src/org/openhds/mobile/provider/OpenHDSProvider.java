...
public class OpenHDSProvider extends ContentProvider {
    ...
    static {
        ...
        individualsProjectionMap.put(OpenHDS.Individuals.COLUMN_INDIVIDUAL_STATUS,
        ...
        // special case to display individuals first name and last name on the value fragment
        ...
        locationsProjectionMap.put(OpenHDS.Locations.COLUMN_LOCATION_HEAD, OpenHDS.Locations.COLUMN_LOCATION_HEAD);
        ...
        locationsProjectionMap.put(OpenHDS.Locations.COLUMN_LOCATION_STATUS, OpenHDS.Locations.COLUMN_LOCATION_STATUS);
        ...
        hierarchyitemsProjectionMap.put(OpenHDS.HierarchyItems.COLUMN_HIERARCHY_UUID,
        ...
        roundsProjectionMap.put(OpenHDS.Rounds.COLUMN_ROUND_UUID, OpenHDS.Rounds.COLUMN_ROUND_UUID);
        ...
        roundsProjectionMap.put(OpenHDS.Rounds.COLUMN_ROUND_REMARKS, OpenHDS.Rounds.COLUMN_ROUND_REMARKS);
        ...
        visitsProjectionMap.put(OpenHDS.Visits.COLUMN_VISIT_STATUS, OpenHDS.Visits.COLUMN_VISIT_STATUS);
        visitsProjectionMap.put(OpenHDS.Visits.COLUMN_VISIT_UUID, OpenHDS.Visits.COLUMN_VISIT_UUID);
        ...
        socialgroupsProjectionMap.put(OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_STATUS,
                OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_STATUS);
        socialgroupsProjectionMap.put(OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_UUID,
                OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_UUID);

        // A duplicate of the default social group projection map but is used in join query. The join query requires the
        ...
        socialgroupsJoinProjectionMap.put(OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_GROUPNAME, "s."
                + OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_GROUPNAME);
        socialgroupsJoinProjectionMap.put(OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_STATUS, "s."
                + OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_STATUS);
        socialgroupsJoinProjectionMap.put(OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_UUID, "s."
                + OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_UUID);
    ...
    static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + OpenHDS.Individuals.TABLE_NAME + " (" + OpenHDS.Individuals._ID
                    + " INTEGER PRIMARY KEY," + OpenHDS.Individuals.COLUMN_INDIVIDUAL_DOB + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_EXTID + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_FATHER + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_FIRSTNAME + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_GENDER + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_LASTNAME + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_MOTHER + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_RESIDENCE + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_STATUS + " TEXT NOT NULL,"
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_UUID + " TEXT NOT NULL," + "FOREIGN KEY("
                    + OpenHDS.Individuals.COLUMN_INDIVIDUAL_RESIDENCE + ") " + "REFERENCES "
                    + OpenHDS.Locations.TABLE_NAME + "(" + OpenHDS.Locations.COLUMN_LOCATION_UUID + "));");
            ...
            db.execSQL("CREATE TABLE " + OpenHDS.Locations.TABLE_NAME + " (" + OpenHDS.Locations._ID
                    ...
                    + OpenHDS.Locations.COLUMN_LOCATION_HEAD + " TEXT NOT NULL,"
                    + OpenHDS.Locations.COLUMN_LOCATION_HIERARCHY + " TEXT NOT NULL,"
                    + OpenHDS.Locations.COLUMN_LOCATION_LATITUDE + " TEXT NOT NULL,"
                    + OpenHDS.Locations.COLUMN_LOCATION_LONGITUDE + " TEXT NOT NULL,"
                    + OpenHDS.Locations.COLUMN_LOCATION_NAME + " TEXT NOT NULL,"
                    + OpenHDS.Locations.COLUMN_LOCATION_STATUS + " TEXT NOT NULL,"
                    + OpenHDS.Locations.COLUMN_LOCATION_UUID + " TEXT NOT NULL);");
            ...
            db.execSQL("CREATE TABLE " + OpenHDS.HierarchyItems.TABLE_NAME + " (" + OpenHDS.HierarchyItems._ID
                    ...
                    + OpenHDS.HierarchyItems.COLUMN_HIERARCHY_UUID + " TEXT NOT NULL," + "FOREIGN KEY("
                    + OpenHDS.HierarchyItems.COLUMN_HIERARCHY_PARENT + ") " + "REFERENCES "
                    + OpenHDS.HierarchyItems.TABLE_NAME + "(" + OpenHDS.HierarchyItems.COLUMN_HIERARCHY_UUID + "));");
            ...
            db.execSQL("CREATE TABLE " + OpenHDS.Rounds.TABLE_NAME + " (" + OpenHDS.Rounds._ID
                    ...
                    + OpenHDS.Rounds.COLUMN_ROUND_NUMBER + " TEXT NOT NULL," + OpenHDS.Rounds.COLUMN_ROUND_REMARKS
                    + " TEXT NOT NULL," + OpenHDS.Rounds.COLUMN_ROUND_STARTDATE + " TEXT NOT NULL,"
                    + OpenHDS.Rounds.COLUMN_ROUND_UUID + " TEXT NOT NULL);");
            ...
            db.execSQL("CREATE TABLE " + OpenHDS.Visits.TABLE_NAME + " (" + OpenHDS.Visits._ID
                    ...
                    + OpenHDS.Visits.COLUMN_VISIT_STATUS + " TEXT NOT NULL," + OpenHDS.Visits.COLUMN_VISIT_UUID
                    + " TEXT NOT NULL," + "FOREIGN KEY (" + OpenHDS.Visits.COLUMN_VISIT_LOCATION + ") REFERENCES "
                    + OpenHDS.Locations.TABLE_NAME + "(" + OpenHDS.Locations.COLUMN_LOCATION_UUID + "));");
            ...
            db.execSQL("CREATE TABLE " + OpenHDS.SocialGroups.TABLE_NAME + " (" + OpenHDS.SocialGroups._ID
                    ...
                    + OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_STATUS + " TEXT NOT NULL,"
                    + OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_UUID + " TEXT NOT NULL," + " FOREIGN KEY ("
                    + OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_GROUPHEAD + ") REFERENCES "
                    + OpenHDS.Individuals.TABLE_NAME + "(" + OpenHDS.Individuals.COLUMN_INDIVIDUAL_UUID + "));");
            ...
            db.execSQL("CREATE TABLE " + OpenHDS.IndividualGroups.TABLE_NAME + " (" + OpenHDS.IndividualGroups._ID
                    ...
                    + OpenHDS.IndividualGroups.COLUMN_SOCIALGROUPUUID + " TEXT NOT NULL," + "FOREIGN KEY ("
                    + OpenHDS.IndividualGroups.COLUMN_INDIVIDUALUUID + ") REFERENCES " + OpenHDS.Individuals.TABLE_NAME
                    + "(" + OpenHDS.Individuals.COLUMN_INDIVIDUAL_EXTID + ")," + "FOREIGN KEY ("
                    + OpenHDS.IndividualGroups.COLUMN_SOCIALGROUPUUID + ") REFERENCES "
                    + OpenHDS.SocialGroups.TABLE_NAME + "(" + OpenHDS.SocialGroups.COLUMN_SOCIALGROUP_EXTID + "));");
        }
    ...
    /**
     * 
     * Initializes the provider by creating a new DatabaseHelper. onCreate() is called automatically when Android
